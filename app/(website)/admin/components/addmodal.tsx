...
interface AddModalProps {
  onClose: () => void;
  handleAddUser: (user: { name: string; email: string; age: number }) => void;
}

const Addmodal: React.FC<AddModalProps> = ({ onClose, handleAddUser }) => {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    e.preventDefault();
    handleAddUser({ name, email, age: parseInt(age) });
    setName("");
    setEmail("");
    setAge("");
    onClose();
